...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      baseUrlLabel: '接口地址',
      modelLabel: '模型',
      geminiModelHint: '所有 Gemini 模型已強制關閉思考模式。可用模型 ID：gemini-2.5-flash（推薦，低延遲）、gemini-2.5-flash-lite、gemini-2.5-pro（官方說明無法關閉思考）、gemini-3.1-pro-preview（最低 LOW 思考檔）、gemini-3-flash-preview、gemini-3.1-flash-lite、gemini-3.1-flash-lite-preview。',
