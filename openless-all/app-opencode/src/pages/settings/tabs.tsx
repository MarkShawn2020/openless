...
import { OpenCodeAgentSection } from './OpenCodeAgentSection';
import { OpenCodeConsoleSection } from './OpenCodeConsoleSection';
...
export function AdvancedTab() {
  ...
  return (
    <>
      ...
      {showDesktopAdvanced && os !== 'win' && <OpenCodeAgentSection />}
      {showDesktopAdvanced && os !== 'win' && <OpenCodeConsoleSection />}
