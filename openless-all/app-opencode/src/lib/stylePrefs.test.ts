...
const previousPrefs: UserPreferences = {
  ...
  opencodeAgentEnabled: false,
  opencodeAgentProvider: 'claude-code-cli',
  opencodeAgentModel: null,
  opencodeAgentPermissionMode: 'acceptEdits',
  opencodeAgentWorkdir: null,
  opencodeAgentVoiceHotkey: { primary: 'LeftControl', modifiers: [] },
  opencodeAgentPanelHotkey: { primary: 'Enter', modifiers: ['cmd', 'shift'] },
  opencodeAgentQuickHotkey: null,
  localAsrActiveModel: '',
